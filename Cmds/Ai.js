...
async function analyzeImage(imageUrl, question) {
    try {
        const apiUrl = `https://apiskeith.vercel.app/ai/gemini-vision?image=${encodeURIComponent(imageUrl)}&q=${encodeURIComponent(question)}`;
...
keith({
    ...
    try {
        ...
        const response = await fetch(`https://apiskeith.vercel.app/ai/flux?q=${encodeURIComponent(text)}`);
