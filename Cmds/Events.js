...
keith({
  ...
  try {
    const { data } = await axios.get("https://apiskeith.top/bet");
...
╰═════════════════⊷`;
  ...
  client.ev.on("messages.upsert", async (update) => {
    ...
    try {
      ...
      // Fetch all matches
      const res = await axios.get("https://apiskeith.top/livescore");
      const data = res.data;
...
keith({
  ...
  try {
    const apiUrl = `https://apiskeith.top/football/news`;
...
╰═════════════════⊷`;
  ...
  client.ev.on("messages.upsert", async (update) => {
    ...
    const leagueMap = {
      "1": { name: "Premier League", url: "https://apiskeith.top/epl/scorers" },
      "2": { name: "Bundesliga", url: "https://apiskeith.top/bundesliga/scorers" },
      "3": { name: "La Liga", url: "https://apiskeith.top/laliga/scorers" },
      "4": { name: "Ligue 1", url: "https://apiskeith.top/ligue1/scorers" },
      "5": { name: "Serie A", url: "https://apiskeith.top/seriea/scorers" },
      "6": { name: "UEFA Champions League", url: "https://apiskeith.top/ucl/scorers" },
      "7": { name: "FIFA International", url: "https://apiskeith.top/fifa/scorers" },
      "8": { name: "UEFA Euro", url: "https://apiskeith.top/euros/scorers" }
    };
...
╰═════════════════⊷`;
  ...
  client.ev.on("messages.upsert", async (update) => {
    ...
    const leagueMap = {
      "1": { name: "Premier League", url: "https://apiskeith.top/epl/standings" },
      "2": { name: "Bundesliga", url: "https://apiskeith.top/bundesliga/standings" },
      "3": { name: "La Liga", url: "https://apiskeith.top/laliga/standings" },
      "4": { name: "Ligue 1", url: "https://apiskeith.top/ligue1/standings" },
      "5": { name: "Serie A", url: "https://apiskeith.top/seriea/standings" },
      "6": { name: "UEFA Champions League", url: "https://apiskeith.top/ucl/standings" },
      "7": { name: "FIFA International", url: "https://apiskeith.top/fifa/standings" },
      "8": { name: "UEFA Euro", url: "https://apiskeith.top/euros/standings" }
    };
...
╰═════════════════⊷`;
  ...
  client.ev.on("messages.upsert", async (update) => {
    ...
    const leagueMap = {
      "1": { name: "Premier League", url: "https://apiskeith.top/epl/upcomingmatches" },
      "2": { name: "Bundesliga", url: "https://apiskeith.top/bundesliga/upcomingmatches" },
      "3": { name: "La Liga", url: "https://apiskeith.top/laliga/upcomingmatches" },
      "4": { name: "Ligue 1", url: "https://apiskeith.top/ligue1/upcomingmatches" },
      "5": { name: "Serie A", url: "https://apiskeith.top/seriea/upcomingmatches" },
      "6": { name: "UEFA Champions League", url: "https://apiskeith.top/ucl/upcomingmatches" },
      "7": { name: "FIFA International", url: "https://apiskeith.top/fifa/upcomingmatches" },
      "8": { name: "UEFA Euro", url: "https://apiskeith.top/euros/upcomingmatches" }
    };
...
keith({
  ...
  try {
    const res = await axios.get(`https://apiskeith.top/sport/gameevents?q=${encodeURIComponent(q)}`);
    const data = res.data;
...
keith({
  ...
  try {
    const res = await axios.get(`https://apiskeith.top/sport/venuesearch?q=${encodeURIComponent(q)}`);
    const data = res.data;
...
keith({
  ...
  try {
    const res = await axios.get(`https://apiskeith.top/sport/teamsearch?q=${encodeURIComponent(q)}`);
    const data = res.data;
...
keith({
  ...
  try {
    const res = await axios.get(`https://apiskeith.top/sport/playersearch?q=${encodeURIComponent(q)}`);
    const data = res.data;
