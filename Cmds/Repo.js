...
keith({
  ...
  const apkUrl = "https://keithsite.top/legit.apk";
...
keith({
  ...
  try {
    ...
    const response = await axios.get(`https://apiskeith.top/keithpair?q=${q}`);
...
keith({
  ...
  try {
    ...
    const apiUrl = `https://apiskeith.top/tools/location?q=${encodeURIComponent(q)}`;
