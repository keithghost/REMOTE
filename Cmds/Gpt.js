...
const CONFIG = {
    ...
    API_URL: "https://apiskeith.vercel.app/ai/mistral",
...
keith({
    ...
    try {
        ...
        try {
            ...
            const apiUrl = `https://apiskeith.vercel.app/ai/bard?q=${encodeURIComponent(text)}`;
...
keith({
    ...
    try {
        ...
        try {
            ...
            const apiUrl = `https://apiskeith.vercel.app/ai/gpt?q=${encodeURIComponent(text)}`;
...
keith({
    ...
    try {
        ...
        try {
            ...
            const apiUrl = `https://apiskeith.vercel.app/ai/deepseek?q=${encodeURIComponent(text)}`;
...
keith({
    ...
    try {
        ...
        try {
            ...
            const apiUrl = `https://apiskeith.vercel.app/ai/blackbox?q=${encodeURIComponent(text)}`;
...
keith({
    ...
    try {
        ...
        try {
            ...
            const apiUrl = `https://apiskeith.vercel.app/ai/ilama?q=${encodeURIComponent(text)}`;
...
keith({
    ...
    try {
        ...
        try {
            ...
            const apiUrl = `https://apiskeith.vercel.app/ai/metai?q=${encodeURIComponent(text)}`;
...
keith({
    ...
    try {
        ...
        try {
            ...
            const apiUrl = `https://apiskeith.vercel.app/ai/gemini?q=${encodeURIComponent(text)}`;
