...
keith({
  ...
  try {
    const res = await axios.get(`https://apiskeith.top/stalker/pinterest?q=${encodeURIComponent(q)}`);
    const data = res.data;
...
keith({
  ...
  try {
    const res = await axios.get(`https://apiskeith.top/stalker/npm?q=${encodeURIComponent(q)}`);
    const data = res.data;
...
keith({
  ...
  try {
    const res = await axios.get(`https://apiskeith.top/stalker/country?region=${encodeURIComponent(q)}`);
    const data = res.data;
...
keith({
  ...
  try {
    const res = await axios.get(`https://apiskeith.top/stalker/wachannel2?url=${encodeURIComponent(q)}`);
    const data = res.data;
...
keith({
  ...
  try {
    const res = await axios.get(`https://apiskeith.top/stalker/ytchannel?user=${encodeURIComponent(q)}`);
    const data = res.data;
...
keith({
  ...
  try {
    const res = await axios.get(`https://apiskeith.top/stalker/twitter?user=${encodeURIComponent(q)}`);
    const data = res.data;
...
keith({
  ...
  try {
    const res = await axios.get(`https://apiskeith.top/stalker/repostalk?url=${encodeURIComponent(q)}`);
    const data = res.data;
...
keith({
  ...
  try {
    const res = await axios.get(`https://apiskeith.top/stalker/ig?user=${encodeURIComponent(q)}`);
    const data = res.data;
...
keith({
  ...
  try {
    const res = await axios.get(`https://apiskeith.top/stalker/tiktok?user=${encodeURIComponent(q)}`);
    const data = res.data;
