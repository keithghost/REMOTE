...
keith({
  ...
  const apiUrl = `https://apiskeith.vercel.app/ai/txt2music?q=${encodeURIComponent(prompt)}`;
...
keith({
  ...
  const apiUrl = `https://apiskeith.vercel.app/ai/txt2video2?q=${encodeURIComponent(prompt)}`;
...
keith({
  ...
  const prompt = arg.join(" ");
  const apiUrl = `https://apiskeith.vercel.app/ai/txt2video?q=${encodeURIComponent(prompt)}`;
