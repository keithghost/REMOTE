...
keith({
  ...
  try {
    // API endpoint
    const apiUrl = `https://apiskeith.vercel.app/download/twitter?url=${encodeURIComponent(tweetUrl)}`;
...
keith({
  ...
  try {
    // API endpoint
    const apiUrl = `https://apiskeith.vercel.app/download/instagramdl?url=${encodeURIComponent(igUrl)}`;
...
keith({
  ...
  try {
    // API endpoint
    const apiUrl = `https://apiskeith.vercel.app/download/mfire?url=${encodeURIComponent(mediafireUrl)}`;
