...
keith({
  ...
  try {
    const response = await axios.get(
      `https://apiskeith.vercel.app/ai/gpt?q=${encodeURIComponent(query)}`,
...
keith({
  ...
  try {
    ...
    const response = await axios.get(`https://apiskeith.vercel.app/ai/deepseek?q=${encodeURIComponent(query)}`);
...
keith({
  ...
  try {
    ...
    const response = await axios.get(`https://apiskeith.vercel.app/ai/blackbox?q=${encodeURIComponent(query)}`);
...
keith({
  ...
  try {
    // Fetch response from the Blackbox API
    const response = await axios.get(`https://apiskeith.vercel.app/ai/ilama?q=${encodeURIComponent(query)}`);
...
keith({
  ...
  try {
    // Fetch response from the Blackbox API
    const response = await axios.get(`https://apiskeith.vercel.app/ai/bard?q=${encodeURIComponent(query)}`);
