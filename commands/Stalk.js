...
keith({
  ...
  try {
    const response = await axios.get(`https://apiskeith.vercel.app/stalker/country?region=${encodeURIComponent(countryName)}`);
...
keith({
  ...
  try {
    const response = await axios.get(`https://apiskeith.vercel.app/stalker/ytchannel?user=${encodeURIComponent(username)}`);
...
keith({
  ...
  try {
    const response = await axios.get(`https://apiskeith.vercel.app/stalker/ig?user=${encodeURIComponent(username)}`);
...
keith({
  ...
  try {
    const response = await axios.get(`https://apiskeith.vercel.app/stalker/tiktok?user=${encodeURIComponent(username)}`);
